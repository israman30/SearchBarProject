...
var teams: [Teams] = [
    ...
    Teams(equipo: "U de Chile",
          descriptionTeam: "The club was founded on May 24, 1927. Universidad de Chile is one of the most successful and popular football clubs in Chile, having won the league title 18 times.[2] In the last 10 years, the team has been crowned champion six times, including their undefeated run to the 2011 Copa Sudamericana title. The team has been throughout its history associated with the blue colour, also present on the logo, which was officially adopted in 1943. The club rivalries are with Colo-Colo and Universidad Católica, with whom they regularly contest the Santiago derbies known as Clásicos.",
          photoEquipo: UIImage(named: "udeChile")
    ),
    Teams(equipo: "Colo Colo",
          descriptionTeam: "Club Social y Deportivo Colo-Colo (Spanish pronunciation: [colo colo]) is a Chilean football club based in Macul, Santiago. Founded in 1925, they play in the Chilean Primera División, from which they have never been relegated.[1] The team plays its home games at Estadio Monumental David Arellano since 1989.[2] Colo-Colo is regarded as the most successful club of Chilean football.",
          photoEquipo: UIImage(named: "colocolo")
    )
]
