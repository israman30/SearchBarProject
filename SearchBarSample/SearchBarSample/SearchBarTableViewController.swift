...
class SearchBarTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    let itemsOnTableView = ["Barcelona", "Real Madrid", "Manchester United", "Liverpool", "Bayer Munich", "Werde Bremme", "AC Milan", "Inter", "Benfica", "Sportin de Lisboa", "Boca Jr", "River Plate", "Flamengo", "Coritians", "U de Chile", "Colo Colo", "Barcelona", "Emelec", "Ateltico Medellin", "America de Cali", "Univeristario de Deporte", "Alianza Lima", "Cerro Portenio", "Olimpia"]
